...
The [EntraAuth](https://github.com/FriedrichWeinmann/EntraAuth){:target="_blank"} module wraps all of the above into a single parameter.
...
Reference: [Microsoft Graph delta query overview](https://learn.microsoft.com/en-us/graph/delta-query-overview){:target="_blank"}
