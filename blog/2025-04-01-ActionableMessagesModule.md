...
![simple example mobile](/assets/img/posts/2025-04-01-ActionableMessagesModule-Basic-mobile.png)
...
![pto example mobile](/assets/img/posts/2025-04-01-ActionableMessagesModule-PTO-mobile.png)
...
![access request example mobile](/assets/img/posts/2025-04-01-ActionableMessagesModule-AccessRequest-mobile.png)
...
![new owner1 example mobile](/assets/img/posts/2025-04-01-ActionableMessagesModule-NewOwner1-mobile.png)

Mobile result selection:

![new owner2 example mobile](/assets/img/posts/2025-04-01-ActionableMessagesModule-NewOwner2-mobile.png)
...
If you already have JSON or want to create it with the [Microsoft Actionable Message Designer](https://amdesigner.azurewebsites.net/) and want to convert it to PowerShell commands:
```powershell
...
For more information and source code, check out the [GitHub repository.](https://github.com/Mynster9361/ActionableMessages)

And also the [documentation.](https://mynster9361.github.io/modules/actionablemessages/)

Reference Links

- [Module on PowerShell Gallery](https://www.powershellgallery.com/packages/ActionableMessages/)
- [Actionable Message Designer](https://amdesigner.azurewebsites.net/)
- [Microsoft Actionable Messages Documentation](https://learn.microsoft.com/en-us/outlook/actionable-messages/get-started)
- [Actionable Email Developer Dashboard](https://mynster9361.github.io/modules/actionablemessages/)
