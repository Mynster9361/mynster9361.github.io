...
> - [Part 2: Resources, Variables, and State in Terraform (July 22)](/2025/07/22/ResourcesVariablesAndStateInTerraform)
> - [Part 3: Advanced Terraform and PowerShell Integration](/2025/07/29/AdvancedTerraformAndPowerShellIntegration)
> - [Part 4: Advanced State Management and Collaboration](/2025/08/05/AdvancedStateManagementAndCollaboration)
> - [Part 5: Testing Terraform Code](/2025/08/19/TestingTerraformCode)
...
[Terraform CICD](https://github.com/Mynster9361/TerraformCICD)
...
[Storage account - Attributes Reference](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/storage_account#attributes-reference)
...
| ---------- | ------------------------------------------------------------------------- | -------------------------------------------------------- |
| **Part 1** | [Getting Started](/2025/07/15/GettingStartedWithTerraformForPowerShellPeople) | Imperative scripts → Declarative configuration           |
| **Part 2** | [Resources & State](/2025/07/22/ResourcesVariablesAndStateInTerraform)        | Variables & objects → Terraform variables & data sources |
| **Part 3** | [Advanced Integration](/2025/07/29/AdvancedTerraformAndPowerShellIntegration) | Hybrid workflows → PowerShell + Terraform synergy        |
| **Part 4** | [State & Collaboration](/2025/08/05/AdvancedStateManagementAndCollaboration)  | Team collaboration & remote state                        |
| **Part 5** | [Testing Strategies](/2025/08/19/TestingTerraformCode)                        | Pester testing → Native Terraform testing framework      |
| **Part 6** | [Module Development](/2025/08/26/TerraformModulesDeepDive)                    | PowerShell modules → Terraform modules & composition     |
