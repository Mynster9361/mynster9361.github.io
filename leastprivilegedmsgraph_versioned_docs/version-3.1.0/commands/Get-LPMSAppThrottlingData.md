---
title: Get-LPMSAppThrottlingData
---

# Get-LPMSAppThrottlingData
...
```
Get-LPMSAppThrottlingData -AppData <Array> -WorkspaceId <String> [-Days <Int32>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### ByWorkspaceDetails
```
Get-LPMSAppThrottlingData -AppData <Array> -subId <String> -rgName <String> -workspaceName <String>
 [-Days <Int32>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
