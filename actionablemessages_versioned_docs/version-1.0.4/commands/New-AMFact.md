...
the content or data associated with the fact.
This separation allows you to display structured information
...
Values can include simple Markdown formatting (e.g., bold, italics).
