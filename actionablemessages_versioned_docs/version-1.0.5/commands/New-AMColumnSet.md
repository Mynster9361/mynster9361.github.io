...
A ColumnSet contains one or more Column objects, each created with the \`New-AMColumn\` function.
Each column can
contain its own set of elements (text, images, etc.).
ColumnSets are highly flexible and can be used to create
