...
FactSets are ideal for displaying property lists, specifications, details, or
...
This layout ensures clarity and organization when presenting structured data.
...
Each fact represents a key-value pair with a Title (key) and Value.
...
### -Id
(Optional) A unique identifier for the FactSet.
This can be useful when you need to reference this element in other
